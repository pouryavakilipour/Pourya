...
namespace TMVA {
   ...
   public:
      ...
      void TrainSingleMethod               (TString datasetname);
      void TrainAllMethodsForClassification( void ) { TrainAllMethods(); }
      void TrainAllMethodsForRegression    ( void ) { TrainAllMethods(); }

      // testing
      void TestAllMethods  ();
      void TestSingleMethod(TString datasetname);
      // performance evaluation
      void EvaluateAllMethods  ( void );
      void EvaluateSingleMethod(TString datasetname);
      void EvaluateAllVariables(DataLoader *loader, TString options = "" ); 
  
      TH1F* EvaluateImportance( DataLoader *loader,VIType vitype, Types::EMVA theMethod,  TString methodTitle, const char *theOption = "" );

      float CrossValidate(DataLoader *loader, Types::EMVA theMethod,  TString methodTitle, const char *theOption = "", bool optParams = false, int NumFolds = 10, bool remakeDataSet = true, float *
      rocIntegrals = nullptr, UInt_t nPro = 8 );

      //float CrossValidate(DataLoader *loader, Types::EMVA theMethod,  TString methodTitle, const char *theOption = "", bool optParams = false, int NumFolds = 10, bool remakeDataSet = true, float *
      //rocIntegrals = nullptr );

      void CrossValidateAUCHisto(DataLoader *loader, Types::EMVA theMethod,  TString methodTitle, const char *theOption = "", bool optParams = false, int NumFolds = 10, bool remakeDataSet = true);

      void CrossValidatePlotROC(DataLoader *loader, Types::EMVA theMethod,  TString methodTitle, const char *theOption = "", bool optParams = false, int NumFolds = 10, bool remakeDataSet = true);


      // delete all methods and reset the method vector
      void DeleteAllMethods( void );
      void DeleteSingleMethod( TString datasetname );
